...
public class MainActivityFragment extends Fragment {
   ...
   private Set<String> regionsSet = new HashSet<>(); // world regions in current quiz
   ...
   public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      animation = AnimationUtils.loadAnimation(getActivity(),R.anim.incorrect_shake);
   ...
   public void updateGuessRows(SharedPreferences sharedPreferences) {
      ...
      //String choices =
      //   sharedPreferences.getString(WelcomeActivity.CHOICES, null);
      guessRows = 2;//Integer.parseInt(choices) / 2;
   ...
   public void updateRegions(SharedPreferences sharedPreferences) {
      //regionsSet =
         //sharedPreferences.getStringSet(WelcomeActivity.REGIONS, null);

         regionsSet.add("Animals");
   }
   ...
   private OnClickListener guessButtonListener = new OnClickListener() {
      ...
      public void onClick(View v) {
         ...
         if (guess.equals(answer)) { // if the guess is correct
            ...
            if (soundOn) {
               MediaPlayer player = MediaPlayer.create(getContext(), R.raw.goat);
               player.start();
            }
           ...
           answerTextView.setText(answer + "!");
            answerTextView.setTextColor(
               //getResources().getColor(R.color.correct_answer, getContext().getTheme()));
                    getResources().getColor(R.color.correct_answer));//, getActivity().getTheme()));
            ...
            if (soundOn) {
               MediaPlayer player = MediaPlayer.create(getContext(), R.raw.cow);
               player.start();
            }
